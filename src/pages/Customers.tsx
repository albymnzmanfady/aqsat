      ...
      <div className="p-4 lg:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-slate-600 mt-2">إضافة وتعديل وحذف بيانات العملاء</p>
          </div>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] rounded-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  أدخل بيانات العميل الجديدة هنا
                </DialogDescription>
              </DialogHeader>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filteredCustomers.map((customer) => (
            <Card key={customer.id} className="rounded-2xl border-slate-100 hover:shadow-lg transition-all duration-300">
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-3 border-t border-slate-100">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm text-slate-600">تقدم الأقساط</span>
        ...
        {filteredCustomers.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-slate-600">لا يوجد عملاء</h3>
